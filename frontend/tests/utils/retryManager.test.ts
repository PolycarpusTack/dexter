// tests/utils/retryManager.test.ts
...
vi.mock('../../src/utils/errorFactory', () => ({
  default: {
    create: vi.fn((error: any, options: any) => ({
      ...error,
      ...options
    }))
  }
...
describe('RetryManager', () => {
  beforeEach(() => {
    ...
    (isRetryableError as MockedFunction<typeof isRetryableError>).mockImplementation((error: any) => {
