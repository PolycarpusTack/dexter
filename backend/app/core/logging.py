...
def get_logger(name: str) -> logging.Logger:
    """Return a module logger. Provided for backward compatibility.

    Modules can import get_logger from app.core.logging to obtain a logger
    without depending on logging configuration details.
    """
