...
from app.constants import JWT_ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES, REFRESH_TOKEN_EXPIRE_DAYS
...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None) -> str:
    ...
    encoded_jwt: str = jwt.encode(to_encode, settings.secret_key, algorithm=JWT_ALGORITHM)
    return encoded_jwt
