...
async def list_templates(
    ...
    return TemplateListResponse(templates=templates, total=total, categories=category_counts)
...
async def render_template(
    ...
    try:
        rendered_content = template_service.render_template(
            template_id=template_id, variables=render_request, version=version
        )
