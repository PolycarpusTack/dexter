...
class AnthropicConfig(BaseModel):
    ...
    # API endpoints
    api_base: str = Field("https://api.anthropic.com", description="Anthropic API base URL.")
    api_version: str = Field("v1", description="Anthropic API version.")
    ...
    default_parameters: Dict[str, any] = Field(
        {"temperature": 0.7, "max_tokens": 1024, "top_p": 1.0, "top_k": 5},
