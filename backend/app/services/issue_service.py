...
class IssueService:
    ...
    async def update_issue_status(
        self, issue_id: str, status: str, user_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def assign_issue(
        self, issue_id: str, assignee: str, user_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def create_comment(self, issue_id: str, text: str, user_id: str) -> Dict[str, Any]:
        """
