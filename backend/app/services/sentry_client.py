...
def get_sentry_client() -> "SentryApiClient":
    ...
    if _sentry_client is None:
        _sentry_client = SentryApiClient(token=settings.get_sentry_token())
...
class SentryApiClient:
    ...
    def __init__(self, token: Optional[str] = None, timeout: int = 30):
        ...
        """
        self.token = token or settings.get_sentry_token()
        self.timeout = timeout
        self.client = httpx.AsyncClient(timeout=timeout)

        # Common parameters
        self.common_params = {"sentry_base_url": settings.sentry_base_url}
    ...
    async def get_issue(self, issue_id: str) -> SentryIssue:
        ...
        Returns:
            Issue object
        """
        url = get_full_url("issues", "detail", issue_id=issue_id, **self.common_params)
    ...
    async def update_issue(
        ...
        **kwargs: Any,
        ...
        """
        url = get_full_url("issues", "update", issue_id=issue_id, **self.common_params)
    ...
    async def bulk_update_issues(
        ...
        """
        url = get_full_url(
            "organization_issues", "bulk", organization_slug=org_slug, **self.common_params
        )

        data = {"ids": issue_ids, **update_params}
    ...
    async def get_issue_events(self, issue_id: str, **params: Any) -> List[Dict[str, Any]]:
        ...
        """
        url = get_full_url("issue_events", "list", issue_id=issue_id, **self.common_params)

        return await self._request("GET", url, params=params)

    async def get_event(self, org_slug: str, project_slug: str, event_id: str) -> SentryEvent:
    ...
    async def get_latest_event(self, issue_id: str) -> SentryEvent:
        ...
        Returns:
            Event object
        """
        url = get_full_url("issue_events", "latest", issue_id=issue_id, **self.common_params)
    ...
    async def assign_issue(self, issue_id: str, assignee: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def add_issue_tags(self, issue_id: str, tags: List[Dict[str, str]]) -> Dict[str, Any]:
    ...
    async def get_issue_event(
        ...
        if event_id in ["latest", "oldest", "recommended"]:
            url = get_full_url("issue_events", event_id, issue_id=issue_id, **self.common_params)
        else:
            # This is a regular event ID, construct the URL differently
            # May need to adjust based on actual API structure
            url = get_full_url(
                "issue_events", "detail", issue_id=issue_id, event_id=event_id, **self.common_params
            )
    ...
    async def list_issue_alert_rules(self, org_slug: str, project_slug: str) -> Dict[str, Any]:
    ...
    async def get_issue_alert_rule(
        self, org_slug: str, project_slug: str, rule_id: str
    ) -> Dict[str, Any]:
    ...
    async def create_issue_alert_rule(
        self, org_slug: str, project_slug: str, rule_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def update_issue_alert_rule(
        self, org_slug: str, project_slug: str, rule_id: str, rule_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def list_metric_alert_rules(self, org_slug: str) -> Dict[str, Any]:
        ...
        """
        url = get_full_url(
            "metric_alert_rules", "list", organization_slug=org_slug, **self.common_params
        )

        return await self._request("GET", url)

    async def get_metric_alert_rule(self, org_slug: str, rule_id: str) -> Dict[str, Any]:
    ...
    async def create_metric_alert_rule(
        self, org_slug: str, rule_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        """
        url = get_full_url(
            "metric_alert_rules", "create", organization_slug=org_slug, **self.common_params
        )

        return await self._request("POST", url, data=rule_data)

    async def update_metric_alert_rule(
        self, org_slug: str, rule_id: str, rule_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def delete_metric_alert_rule(self, org_slug: str, rule_id: str) -> Dict[str, Any]:
    ...
    async def get_event_by_id(self, event_id: str) -> Dict[str, Any]:
        ...
        """
        url = get_full_url(
            "event_analysis", "get_event_by_id", event_id=event_id, **self.common_params
        )
    ...
    async def discover_query(self, org_slug: str, query_params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Returns:
            Query results
        """
        url = get_full_url("discover", "query", organization_slug=org_slug, **self.common_params)

        return await self._request("GET", url, params=query_params)

    async def get_discover_saved_queries(self, org_slug: str) -> List[Dict[str, Any]]:
        ...
        """
        url = get_full_url(
            "discover", "saved_queries", organization_slug=org_slug, **self.common_params
        )
    ...
    async def create_discover_saved_query(
        self, org_slug: str, query_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        """
        url = get_full_url(
            "discover", "create_saved_query", organization_slug=org_slug, **self.common_params
        )
