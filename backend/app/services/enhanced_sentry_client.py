...
class EnhancedSentryClient(SentryApiClient):
    ...
    async def get_issue_details(self, organization_slug: str, issue_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Issue details
        """
        params = {"organization_slug": organization_slug, "issue_id": issue_id}

        return await self.call_endpoint("get_issue_details", params)

    async def update_issue_status(
        self, issue_id: str, status: str, organization_slug: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def discover_query(
        ...
        params = {"organization_slug": organization_slug, **query_params}

        return await self.call_endpoint("discover_query", params)

    async def get_discover_saved_queries(self, organization_slug: str) -> List[Dict[str, Any]]:
        """
    ...
    async def create_discover_saved_query(
        ...
        return await self.call_endpoint(
            "create_discover_saved_query", params, query_data, method="POST"
        )
...
async def get_enhanced_sentry_client(
    ...
    enhanced_client = EnhancedSentryClient(token=sentry_client.token, timeout=sentry_client.timeout)
