...
def format_single_issue_to_csv_row(
    issue_dict: Dict[str, Any], writer: csv.DictWriter, string_io: io.StringIO
) -> str:
    ...
    try:
        ...
        err_dict = {
            h: f"Error formatting row {issue_dict.get('id', 'N/A')}" if h == "id" else ""
