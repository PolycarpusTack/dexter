...
class SentryAPIError(DexterError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, status_code=status_code, code="SENTRY_API_ERROR", details=details
        )
...
class LLMServiceError(DexterError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, status_code=status_code, code="LLM_SERVICE_ERROR", details=details
        )
...
def format_validation_errors(exc: RequestValidationError) -> Dict[str, Any]:
    ...
    for error in exc.errors():
        ...
        errors.append({"field": loc, "type": err_type, "message": msg})
